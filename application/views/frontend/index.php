            ...
            <div class="{v2_36_MOBILE_ON_OFF} {v2_36_TABLET_ON_OFF} {v2_36_DESKTOP_ON_OFF}">
                <div class="row-block slider">
                    <div class="new-slider">
                        ...
                        <div class="slider-content" style="background:#404040 url(<?= site_url('assets/img/theme/slide-3.jpg') ?>)!important;background-size:cover!important;background-repeat:no-repeat!important;background-position:center center!important; width: 100%; height: 550px">
                            <div class="content">
                                <h2>Main heading3</h2>
                                <em>Sub heading3</em>
                                <a class="btn" href="">Click</a>
...
<option value="14500">&pound;14500</option>
            ...
            <!-- // END Homepage Horizontal Search -->
                                ...
                                <div class="brand-logos">
                                    <div class="pad-10 overflow-hidden">
                                        <div class="row brands">
                                            <a href="#" title="Used AUDI for sale in Walsall"><img src="<?= site_url('assets/img/brands/')?>audi.png" alt="Used AUDI for sale in Walsall" /></a>
                                            <a href="" title="Used BMW for sale in Walsall"><img src="<?= site_url('assets/img/brands/')?>bmw.png" alt="Used BMW for sale in Walsall" /></a>
                                            <a href="" title="Used FORD for sale in Walsall"><img src="<?= site_url('assets/img/brands/')?>ford.png" alt="Used FORD for sale in Walsall" /></a>
                                            <a href="" title="Used HYUNDAI for sale in Walsall"><img src="<?= site_url('assets/img/brands/')?>hyundai.png" alt="Used HYUNDAI for sale in Walsall" /></a>
                                            <a href="" title="Used JAGUAR for sale in Walsall"><img src="<?= site_url('assets/img/brands/')?>jaguar.png" alt="Used JAGUAR for sale in Walsall" /></a>
                                            <a href="" title="Used MERCEDES-BENZ for sale in Walsall"><img src="<?= site_url('assets/img/brands/')?>mercedes-benz.png" alt="Used MERCEDES-BENZ for sale in Walsall" /></a>
                                            <a href="used-mini-walsall-west-midlands.html" title="Used MINI for sale in Walsall"><img src="<?= site_url('assets/img/brands/')?>mini.png" alt="Used MINI for sale in Walsall" /></a>
                                            <a href="used-nissan-walsall-west-midlands.html" title="Used NISSAN for sale in Walsall"><img src="<?= site_url('assets/img/brands/')?>nissan.png" alt="Used NISSAN for sale in Walsall" /></a>
                                            <a href="used-peugeot-walsall-west-midlands.html" title="Used PEUGEOT for sale in Walsall"><img src="<?= site_url('assets/img/brands/')?>peugeot.png" alt="Used PEUGEOT for sale in Walsall" /></a>
                                            <a href="used-volkswagen-walsall-west-midlands.html" title="Used VOLKSWAGEN for sale in Walsall"><img src="<?= site_url('assets/img/brands/')?>volkswagen.png" alt="Used VOLKSWAGEN for sale in Walsall" /></a>
                                            <a href="used-volvo-walsall-west-midlands.html" title="Used VOLVO for sale in Walsall"><img src="<?= site_url('assets/img/brands/')?>volvo.png" alt="Used VOLVO for sale in Walsall" /></a>
            ...
            <div class="{v2_7_MOBILE_ON_OFF} {v2_7_TABLET_ON_OFF} {v2_7_DESKTOP_ON_OFF}">
                <div class="row-block car-carousel">
                    <div class="wrapper">
                        <div class="container" id="latest-arival">
                            <div class="row">
                                <div class="pad-10 overflow-hidden">
