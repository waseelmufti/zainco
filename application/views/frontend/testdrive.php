                ...
                <div class="wrapper">
                    <div class="row">
                        ...
                        <div class="sixcol block">
                            <div class="pad-20">
                               <h2><span aria-hidden="true" class="icon icon-comments"></span> Book test drive</h2>
                                <p><strong>Book a test drive:</strong><br/><?= $car[0]->registered . ' ' . $car[0]->makeof . ' ' . $car[0]->model?><br/><?= $car[0]->title ?><br/><br/><br/>Fill in the form below and a member of our sales team will be in touch to arrange your test drive.</p>

                                <!--<form action="email.php?modal=1" method="post">-->
                                <?= form_open('enquiry') ?>
                                    <fieldset>
                                       <input type="hidden" name="form_type" value="testdrive">
                                        <input type="hidden" name="vehicle_id" value="<?= $car[0]->id ?>">
                                        <input type="hidden" name="subject" value="Book test drive: <?= $car[0]->registered . ' ' . $car[0]->makeof . ' ' . $car[0]->model?>">
