...
background-size: cover;">
    ...
    <!-- Servicing -->
    <h3 id="service"><span aria-hidden="true" class=" -heart-2"></span> Vehicle Health</h3>
    
      Vehicle Health Check from Best cars takes around 30 minutes
       <ul class="tick">
           <li> Free duty of care vehicle check</li>
           <li> Tyre tread, pressure & condition check</li>
           <li> Visual exhaust check</li>
           <li> Visual suspension check</li>
           <li> Battery charge check</li>
           <li> Oil level check</li>
           <li> Lights check</li>
           <li> Screen washer check</li>
           <li> Wipers check</li>
           <li> Air conditioning check (if applicable)</li>
       </ul> 
    <br>
    Bodywork
       <ul class="tick">
       ...
       <br>
    <p>
       A visual inspection of the exhaust and its mountings is carried out to check for physical damage, leaking joints and corrosion. Where fitted, the physical condition of the catalytic converter is also checked.
    </p>
         
    <div class="form">
    <?php 
    $data['form_type'] = 'vehiclehealth'; /*cardignose-servicing-vehiclehealth*/
