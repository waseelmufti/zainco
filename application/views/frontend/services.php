...
<div class="eightcol block">
  <div class="pad-20 overflow-hidden">
    ...
    <p><strong>Globe Motors offer a full range of services:</strong></p>
    ...
    <p>Vehicles in Britain are subject to an annual MOT test.</p>
    <p>For vehicles that come within the MOT scheme, testing is mandatory every year after the vehicle is three years old.</p>
    <p>For more information regarding the MOT test scheme visit the Direct.gov.uk website.</p>
    ...
    <p>A small investment in routine servicing, plus a good inspection programme, results in good return on that investment because of:</p>

    <ul class="list-ticks">
      <li>Reduced cost of repairs over the car's coming years</li>
      <li>Peace of mind reducing the risk of breakdowns.</li>
      <li>Will reduce your costs for repairs in the future</li>
      <li>Less chance of accidents</li>
      <li>The possibility of greater fuel economy and keeps the vehicle to its maximum working order</li>
    </ul>
    ...
    <p>When your brakes have a problem, common signs include below:</p>
    <p>If your car is exhibiting any of these signs, don't hesitate to Globe Motors Service Team as soon as possible to prevent further damage and cost to your pocket.</p>

    <ul class="list-ticks">
      <li>Brake juddering when applied</li>
      <li>A grinding noise when brakes applied</li>
      <li>A high, hard brake pedal</li>
      <li>Rear wheels locking upon braking</li>
      <li>A squealing or grinding noise when braking</li>
      <li>If the vehicle pulls to one side when braking</li>
      <li>A loss of efficiency during heavy braking or on a long descent</li>
      <li>A general grinding noise when driving</li>
    </ul>
    <a href="booking_enquiry.html" title="Book In Online" class="button bespoke large">Book In</a>
    ...
    <p>All cars are now fitted with computers and a myriad of technology to run and monitor the internal workings of the vehicle. One of the most important functions these computers provide is ensuring your car
      ...
      indicators illuminates on the dashboard.</p>
    <a href="booking_enquiry.html" title="Book In Online" class="button bespoke large">Book In</a>
