                    ...
                    <div class="row">
                        ...
                        <div class="sixcol block">
                            <div class="pad-20">
                                ...
                                <h2><span aria-hidden="true" class="icon icon-comments"></span> Reserve This Vehicle</h2>
                                <p><strong>Reserving:</strong><br/><?= $car[0]->registered . ' ' . $car[0]->makeof . ' ' . $car[0]->model?><br/><?= $car[0]->title ?><br/><br/>Fill in the form below and a member of our sales team will be in touch to take your deposit.</p>
                                ...
                                <?= form_open('enquiry') ?>
                                    <fieldset>
                                       <input type="hidden" name="form_type" value="reserve">
                                        ...
                                        <input type="hidden" name="subject" value="Application to reserve vehicle: <?= $car[0]->registered . ' ' . $car[0]->makeof . ' ' . $car[0]->model?>">
