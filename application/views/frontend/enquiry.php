                    ...
                    <div class="row">
                        ...
                        <div class="sixcol block">
                            <div class="pad-20">
                                ...
                                <h2><span aria-hidden="true" class="icon icon-comments"></span> Request a call back</h2>
                                <p><strong>Enquiry about:</strong><br/><?= $car[0]->registered . ' ' . $car[0]->makeof . ' ' . $car[0]->model?><br/><?= $car[0]->title ?><br/><br/>Fill in the form below and a member of our sales team will be in touch shortly.</p>
                                ...
                                <?= form_open('enquiry') ?>
                                    <fieldset>
                                       <input type="hidden" name="form_type" value="enquiry">
                                        ...
                                        <input type="hidden" name="subject" value="Enquiry about: <?= $car[0]->registered . ' ' . $car[0]->makeof . ' ' . $car[0]->model?>">
