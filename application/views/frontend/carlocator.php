  ...
  <div id="page-warrior">
	<div id="sourcing-pg">
	  <div class="container">
	    <div class="wrapper">
	      <div class="row">
			<!-- Vehicle Locator Content -->
<div class="eightcol block">
    <div class="pad-20 overflow-hidden">
        <div class="row mobile-hidden">
            <div class="twelvecol page-hdr" id="page-hdr-sourcing" style="background: url(<?= site_url('assets/img/theme/page-hdr-sourcing.jpg')?>) center top no-repeat;
background-size: cover;">
                <h1>Vehicle Sourcing</h1>
            </div>
        </div>
        <div class="clear"></div>
        ...
        <p><strong>Not found the right car yet? Let us source it for you.</strong></p>
        <p>Globe Motors have many years' experience within the used car motor trade and over the years we have built up a trusted network of dealers who we can rely upon to source the best quality vehicles through.</p>
        <h2>Let us do all the legwork</h2>
        <p>Simply fill out the Vehicle Locator form below to start the process, once we have all the relevant details we can start to contact our trusted network in order to find you that perfect car - you don't even have to leave the house.</p>
        <div class="row fin-calc-form"><div class="twelvecol"><iframe id="frame_finance" scrolling="yes" frameborder="0" width="100%" height="1200px" src="https://www.vehicle-enquiry.co.uk/forms/car_locator/index.php?url=http://www.globemotorswalsall.co.uk&amp;website_type=car" ></iframe></div></div>
    </div>
</div>
<!-- // END Vehicle Locator -->
