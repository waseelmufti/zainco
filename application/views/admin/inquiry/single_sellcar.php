  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Sell Your Car</h3>
      ...
      <div class="box-body">
       <p>
          <h2>Form Title: <?= ($form[0]->form_type == 'sellcar')? 'Sell Your Car': '' ?></h2>
...
<!--            <a href="mailto:<?= $contact[0]->email ?>" class="btn btn-success">Reply</a>-->
            <a href="<?= site_url('admin/dashboard/sell-car') ?>" class="btn btn-danger">Back</a>
        </div>
      </div>
      <!-- /.box-footer-->
    </div>
