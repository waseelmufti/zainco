...
<!-- Mirrored from www.globemotorswalsall.co.uk/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 May 2018 20:07:26 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>

  <title>Used cars for sale in Walsall & West Midlands: Globe Motors</title>
 ...
 <link rel="stylesheet" type="text/css" href="style.css">
  ...
  <link rel="icon" type="image/png" href="img-src/_themev2-globemotors-1372/theme/favicon.png">
          ...
          <div class="twelvecol dropdown-bar">
            <div> 
                ...
                <ul id="dropdown-nav" class="nav">
                  <li class="n1 current"><a class="n1 current " href="index.html"   title="Home">Home <span aria-hidden="true" class="icon icon-arrow-down"></span></a>
</li>
 <li class="n2 "><a class="n2  " href="showroom.php"   title="Showroom">Showroom <span aria-hidden="true" class="icon icon-arrow-down"></span></a>
</li>
 
 <li class="n4 "><a class="n4  parent" href="nolink.html"  onclick="return false;" title="Vehicle Valuation">Vehicle Valuation <span aria-hidden="true" class="icon icon-arrow-down"></span></a>
 <ul>

 <li class="n2 "><a class="n2 " href="sellcar.php"   title="Looking to sell?">Looking to sell?</a></li> </ul></li>
  <li class="n5 "><a class="n5  parent" href="nolink.html"  onclick="return false;" title="Our Services">Our Services <span aria-hidden="true" class="icon icon-arrow-down"></span></a>
<ul>
<li class="n1 "><a class="n1 " href="car_locator.php"   title="Vehicle Sourcing">Vehicle Sourcing</a></li> 
<li class="n2 "><a class="n2 " href="servicing.php"   title="Servicing">Servicing</a></li> </ul></li>
 ...
 <ul>
<li class="n1 "><a class="n1 " href="about.php"   title="About Us">About Us</a></li> <li class="n2 "><a class="n2 " href="testimonials.php"   title="Testimonials">Testimonials</a></li> </ul></li>
 <li class="n7 "><a class="n7  " href="contact.php"   title="Contact">Contact <span aria-hidden="true" class="icon icon-arrow-down"></span></a>
</li> 
                </ul>
